...
import SettingUpdateComponent from '@/entities/setting/setting-update.vue';
import SettingClass from '@/entities/setting/setting-update.component';
...
describe('Component Tests', () => {
  describe('Setting Management Update Component', () => {
    ...
    beforeEach(() => {
      ...
      wrapper = shallowMount<SettingClass>(SettingUpdateComponent, {
        store,
        i18n,
        localVue,
        router,
    ...
    describe('save', () => {
      it('Should call update service on save for existing entity', async () => {
        ...
        const entity = { id: 123 };
        comp.setting = entity;
        settingServiceStub.update.resolves(entity);
        ...
        // THEN
        expect(settingServiceStub.update.calledWith(entity)).toBeTruthy();
    ...
    describe('Before route enter', () => {
      it('Should retrieve data', async () => {
        ...
        settingServiceStub.retrieve.resolves([foundSetting]);

    ...
    describe('Service methods', () => {
      it('should find an element', async () => {
        const returnedFromService = Object.assign(
          {
            shippingDate: dayjs(currentDate).format(DATE_TIME_FORMAT),
            fulfillmentDate: dayjs(currentDate).format(DATE_TIME_FORMAT),
            cancelledAt: dayjs(currentDate).format(DATE_TIME_FORMAT),
          },
          elemDefault
        );

...
import RankUpdateComponent from '@/entities/rank/rank-update.vue';
import RankClass from '@/entities/rank/rank-update.component';
...
describe('Component Tests', () => {
  describe('Rank Management Update Component', () => {
    ...
    beforeEach(() => {
      ...
      wrapper = shallowMount<RankClass>(RankUpdateComponent, {
        store,
        i18n,
        localVue,
        router,
    ...
    describe('save', () => {
      it('Should call update service on save for existing entity', async () => {
        ...
        const entity = { id: 123 };
        comp.rank = entity;
        rankServiceStub.update.resolves(entity);
        ...
        // THEN
        expect(rankServiceStub.update.calledWith(entity)).toBeTruthy();
      ...
      it('Should call create service on save for new entity', async () => {
        ...
        const entity = {};
        comp.rank = entity;
        rankServiceStub.create.resolves(entity);
        ...
        // THEN
        expect(rankServiceStub.create.calledWith(entity)).toBeTruthy();
        expect(comp.isSaving).toEqual(false);
      });
    });
    ...
    describe('Before route enter', () => {
      it('Should retrieve data', async () => {
        ...
        rankServiceStub.retrieve.resolves([foundRank]);

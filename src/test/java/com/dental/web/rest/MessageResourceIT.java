...
class MessageResourceIT {
    ...
    private static final Integer DEFAULT_IS_READ = 1;
    private static final Integer UPDATED_IS_READ = 2;
    ...
    public static Message createEntity(EntityManager em) {
        Message message = new Message().userId(DEFAULT_USER_ID).channel(DEFAULT_CHANNEL).message(DEFAULT_MESSAGE).isRead(DEFAULT_IS_READ);
        return message;
    }
    ...
    public static Message createUpdatedEntity(EntityManager em) {
        Message message = new Message().userId(UPDATED_USER_ID).channel(UPDATED_CHANNEL).message(UPDATED_MESSAGE).isRead(UPDATED_IS_READ);
        return message;
    }
    ...
    void createMessage() throws Exception {
        ...
        assertThat(testMessage.getChannel()).isEqualTo(DEFAULT_CHANNEL);
    ...
    void putNewMessage() throws Exception {
        ...
        updatedMessage.userId(UPDATED_USER_ID).channel(UPDATED_CHANNEL).message(UPDATED_MESSAGE).isRead(UPDATED_IS_READ);
        ...
        assertThat(testMessage.getChannel()).isEqualTo(UPDATED_CHANNEL);
    ...
    void fullUpdateMessageWithPatch() throws Exception {
        ...
        partialUpdatedMessage.userId(UPDATED_USER_ID).channel(UPDATED_CHANNEL).message(UPDATED_MESSAGE).isRead(UPDATED_IS_READ);

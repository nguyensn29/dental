...
class CategoryResourceIT {
    ...
    public static Category createEntity(EntityManager em) {
        Category category = new Category().name(DEFAULT_NAME).type(DEFAULT_TYPE).icon(DEFAULT_ICON).imgPublicId(DEFAULT_IMG_PUBLIC_ID);
        return category;
    }
    ...
    public static Category createUpdatedEntity(EntityManager em) {
        Category category = new Category().name(UPDATED_NAME).type(UPDATED_TYPE).icon(UPDATED_ICON).imgPublicId(UPDATED_IMG_PUBLIC_ID);
        return category;
    }
    ...
    void createCategory() throws Exception {
        ...
        assertThat(testCategory.getImgPublicId()).isEqualTo(DEFAULT_IMG_PUBLIC_ID);
    }
    ...
    void putNewCategory() throws Exception {
        ...
        updatedCategory.name(UPDATED_NAME).type(UPDATED_TYPE).icon(UPDATED_ICON).imgPublicId(UPDATED_IMG_PUBLIC_ID);
        ...
        assertThat(testCategory.getImgPublicId()).isEqualTo(UPDATED_IMG_PUBLIC_ID);
    }
    ...
    void partialUpdateCategoryWithPatch() throws Exception {
        ...
        partialUpdatedCategory.name(UPDATED_NAME).imgPublicId(UPDATED_IMG_PUBLIC_ID);
    ...
    void fullUpdateCategoryWithPatch() throws Exception {
        ...
        partialUpdatedCategory.name(UPDATED_NAME).type(UPDATED_TYPE).icon(UPDATED_ICON).imgPublicId(UPDATED_IMG_PUBLIC_ID);

...
public class OrderDetails implements Serializable {
    ...
    public OrderDetails productType(Integer productType) {
    ...
    public OrderDetails avatar(String avatar) {
    ...
    public OrderDetails point(Integer point) {
        this.setPoint(point);
        return this;
    }
    ...
    public OrderDetails discount(Double discount) {
    ...
    public OrderDetails subtotalAmount(Double subtotalAmount) {
    ...
    public OrderDetails totalAmount(Double totalAmount) {
    ...
    public OrderDetails variantId(Double variantId) {
    ...
    public OrderDetails shopifyVariantId(Long shopifyVariantId) {
    ...
    public OrderDetails shopifyProductId(Long shopifyProductId) {
    ...
    public OrderDetails shopifyOrderId(Long shopifyOrderId) {
    ...
    public OrderDetails shopifyId(Long shopifyId) {
